...
const (
	AuthService_IssueTokenPair_FullMethodName      = "/taskmanager.auth.v1.AuthService/IssueTokenPair"
	AuthService_ValidateAccessToken_FullMethodName = "/taskmanager.auth.v1.AuthService/ValidateAccessToken"
	AuthService_RefreshTokenPair_FullMethodName    = "/taskmanager.auth.v1.AuthService/RefreshTokenPair"
	AuthService_RevokeRefreshToken_FullMethodName  = "/taskmanager.auth.v1.AuthService/RevokeRefreshToken"
)
...
type AuthServiceClient interface {
	IssueTokenPair(ctx context.Context, in *IssueTokenPairRequest, opts ...grpc.CallOption) (*TokenPair, error)
	...
	RefreshTokenPair(ctx context.Context, in *RefreshTokenPairRequest, opts ...grpc.CallOption) (*TokenPair, error)
...
func (c *authServiceClient) IssueTokenPair(ctx context.Context, in *IssueTokenPairRequest, opts ...grpc.CallOption) (*TokenPair, error) {
...
func (c *authServiceClient) RefreshTokenPair(ctx context.Context, in *RefreshTokenPairRequest, opts ...grpc.CallOption) (*TokenPair, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenPair)
	err := c.cc.Invoke(ctx, AuthService_RefreshTokenPair_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	IssueTokenPair(context.Context, *IssueTokenPairRequest) (*TokenPair, error)
	ValidateAccessToken(context.Context, *ValidateAccessTokenRequest) (*ValidateAccessTokenResponse, error)
	RefreshTokenPair(context.Context, *RefreshTokenPairRequest) (*TokenPair, error)
...
func (UnimplementedAuthServiceServer) IssueTokenPair(context.Context, *IssueTokenPairRequest) (*TokenPair, error) {
...
func (UnimplementedAuthServiceServer) RefreshTokenPair(context.Context, *RefreshTokenPairRequest) (*TokenPair, error) {
	return nil, status.Error(codes.Unimplemented, "method RefreshTokenPair not implemented")
}
...
func _AuthService_RefreshTokenPair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RefreshTokenPairRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).RefreshTokenPair(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_RefreshTokenPair_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).RefreshTokenPair(ctx, req.(*RefreshTokenPairRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "taskmanager.auth.v1.AuthService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_RefreshTokenPair_Handler,
		},
		{
