...
const (
	AuthService_IssueToken_FullMethodName    = "/taskmanager.auth.v1.AuthService/IssueToken"
	AuthService_ValidateToken_FullMethodName = "/taskmanager.auth.v1.AuthService/ValidateToken"
)
