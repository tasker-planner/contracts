...
const (
	TaskService_CreateTask_FullMethodName     = "/taskmanager.tasks.v1.TaskService/CreateTask"
	TaskService_ListTasks_FullMethodName      = "/taskmanager.tasks.v1.TaskService/ListTasks"
	TaskService_UpdateTask_FullMethodName     = "/taskmanager.tasks.v1.TaskService/UpdateTask"
	TaskService_DeleteTask_FullMethodName     = "/taskmanager.tasks.v1.TaskService/DeleteTask"
	TaskService_RunDailyReport_FullMethodName = "/taskmanager.tasks.v1.TaskService/RunDailyReport"
)
...
type TaskServiceClient interface {
	...
	RunDailyReport(ctx context.Context, in *RunDailyReportRequest, opts ...grpc.CallOption) (*RunDailyReportResponse, error)
}
...
func (c *taskServiceClient) RunDailyReport(ctx context.Context, in *RunDailyReportRequest, opts ...grpc.CallOption) (*RunDailyReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RunDailyReportResponse)
	err := c.cc.Invoke(ctx, TaskService_RunDailyReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	RunDailyReport(context.Context, *RunDailyReportRequest) (*RunDailyReportResponse, error)
...
func (UnimplementedTaskServiceServer) RunDailyReport(context.Context, *RunDailyReportRequest) (*RunDailyReportResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RunDailyReport not implemented")
}
...
func _TaskService_RunDailyReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunDailyReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).RunDailyReport(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_RunDailyReport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).RunDailyReport(ctx, req.(*RunDailyReportRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "taskmanager.tasks.v1.TaskService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RunDailyReport",
			Handler:    _TaskService_RunDailyReport_Handler,
		},
	},
